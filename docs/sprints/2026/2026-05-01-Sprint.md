...
## 2. Data Cleanliness
The goal of this project is to help nonprofit Salesforce practitioners navigate best practices for data quality, identify common pain points, and develop tangible community resources for improving data management.
