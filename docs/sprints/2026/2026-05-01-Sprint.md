...
Building on the community-led success of NPSP best practices resources, this project is actively developing practical guidance to help nonprofits adopt and get the most out of Agentforce Nonprofit. Organized into focused sub-groups, the team is moving beyond discovery and into building real, published resources — including decision frameworks, migration guidance, and adoption tools — that practitioners can use today.

The Best Practices project is divided into a number of focused subgroups; 3 subgroups participated in this Sprint: Discovery Framework, Migration Guidance and Stakeholders. Below is a summary of the subgroup's progress.
