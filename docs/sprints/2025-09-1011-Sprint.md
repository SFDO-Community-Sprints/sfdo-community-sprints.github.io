...
* AI Agent Development: Began building two AI "agents" in Salesforce—one for Donor Stewardship and another for event creation. The team successfully added custom actions but encountered errors that need debugging. They also successfully configured an agent to use Salesforce Knowledge Articles as its primary data source, switching over from its initial web-based configuration.
