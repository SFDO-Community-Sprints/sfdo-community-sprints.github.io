...
Over lunch, we were thrilled to host a Meet the Makers session focused on Agentforce Nonprofit (formerly called Nonprofit Cloud), featuring an absolutely ALLSTAR lineup:
...
* AI for Nonprofits
* Automate the Case Notes Processing within the Participant Management Agent (aka “Truffle Hogs”)
...
* Navigated and documented solutions for technical obstacles including Nonprofit Cloud data model familiarization, Prospect Research Agent access configuration, and deployment tooling.
