...
Join the NEW Commons Project: AI for Nonprofits group in the Trailblazer Community to ask questions or get involved.
2. Declarative Lookup Rollup Summaries (DLRS): User-friendly wizard to understand relationships between different sets of data in Salesforce
...
Education Cloud Trailblazers Group Photo, Virtual Sprint 2025
...
The Nonprofit Salesforce How-To Video team creates short, digestible how-to videos from Nonprofit Cloud documentation. Connect with the team, and watch the videos.
...
Nonprofit Cloud Best Practices group photo, Virtual Sprint 2025
8. NPSP Data Kit for Data Cloud
...
9. Sprinty’s Community Resources: Curated community content to help nonprofits find what they need, fast!
...
PIC 4
Sprinty’s Community Resources group photo, Virtual Sprint 2025
10. Summit Events App (SEA): Community-built event management solution for Nonprofits and Schools
