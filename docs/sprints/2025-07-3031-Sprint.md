...
We were thrilled to gather our Nonprofit and Education community virtually for two days of brainstorming, creating impactful solutions, and fun networking to build community solutions for common challenges affecting Nonprofits and Schools. For this virtual sprint, polled folks on timezone preferences and overwhelmingly got feedback to host in this timezone (timezones are always something we are mindful of as we engage our global community via virtual sprints and something we will continue to keep in mind as we go forward!).
