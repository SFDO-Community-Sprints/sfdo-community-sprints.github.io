...
A remarkable 50 attendees joined us in person, representing an array of folks working within the Nonprofit and Education and Salesforce ecosystems, including End Users, Administrators, Developers, Architects, etc from customer and Industry Partners from not just Chicago but we had folks from 24 different states (!) and 5 different provinces in Canada. Wow!
...
[Image: IMG_1264.jpeg]*The AI Prompts for Nonprofits group in action during the Sprint, November 2024*
